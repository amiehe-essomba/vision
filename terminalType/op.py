...
def operators(name : str = "monokai"):
    op = {
        ...
        "orion"     : CB.codeBgColor(name="orion")      + colors.fg.rbg(255, 102, 150), 
        "pegasus"   : CB.codeBgColor(name="pegasus")    + colors.fg.rbg(255, 102, 255),
        "solo"      : CB.codeBgColor(name="solo")       + colors.fg.rbg(255, 0, 200), 
        "skyBlue"   : CB.codeBgColor(name="skyBlue")    + colors.fg.rbg(100, 102, 140),
        "mirage"    : CB.codeBgColor(name="mirage")     + colors.fg.rbg(25, 55, 140),
        "material"  : CB.codeBgColor(name="material")   + colors.fg.rbg(160, 160, 130),
